...
var proto_app_pb = require('../proto/app_pb.js');

function serialize_app_service_BacktestRequest(arg) {
  if (!(arg instanceof proto_app_pb.BacktestRequest)) {
...
function deserialize_app_service_BacktestRequest(buffer_arg) {
  return proto_app_pb.BacktestRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_service_BacktestResponse(arg) {
  if (!(arg instanceof proto_app_pb.BacktestResponse)) {
...
function deserialize_app_service_BacktestResponse(buffer_arg) {
  return proto_app_pb.BacktestResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_service_PairwiseAnalysisRequest(arg) {
  if (!(arg instanceof proto_app_pb.PairwiseAnalysisRequest)) {
...
function deserialize_app_service_PairwiseAnalysisRequest(buffer_arg) {
  return proto_app_pb.PairwiseAnalysisRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_app_service_PairwiseAnalysisResponse(arg) {
  if (!(arg instanceof proto_app_pb.PairwiseAnalysisResponse)) {
...
function deserialize_app_service_PairwiseAnalysisResponse(buffer_arg) {
  return proto_app_pb.PairwiseAnalysisResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var AppServiceService = exports.AppServiceService = {
  pairwiseAnalysis: {
    ...
    requestType: proto_app_pb.PairwiseAnalysisRequest,
    responseType: proto_app_pb.PairwiseAnalysisResponse,
  ...
  backtest: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: proto_app_pb.BacktestRequest,
    responseType: proto_app_pb.BacktestResponse,
